...
V tabulce \ref{tab:device_prices} lze vidět seznam zařízení, jejich cenu a zdroj ceny. Ceny byly získány 16.04.2021 a případně převedeny do českých korun dle kurzu k tomuto dni.

\begin{table}[H]
    \centering
    \resizebox{\textwidth}{!}{
    \begin{tabular}{?{1.5pt}C{4cm}|C{2.5cm}|C{10.5cm}?{1.5pt}}\noalign{\hrule height 1.5pt}
        \textbf{Produkt} & \textbf{Cena za kus bez DPH} & \textbf{Zdroj} \\\noalign{\hrule height 1.5pt}
        ...
        Schneider Electric Unity Pro & \koruna{102299.92} &  \url{https://cz.wiautomation.com/schneider-electric/software/UNYUPDSPUXUG} \\\noalign{\hrule height 1.5pt}
    \end{tabular}
    }
