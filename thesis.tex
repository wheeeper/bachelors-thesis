...
% Bachelor's thesis by Martin Štěpánek 
...
% frontmatter pseudo chapters: named part without printing actual chapter heading
\makeatletter
...
\makeatother
% frontmatter pseudo chapters end
...
% CZE/SLO: Vyberte jedno z fakultou schválených prohlášení. NEVKLADEJTE VLASTNI TEXT. Schválená prohlášení najdete zde: https://courses.fit.cvut.cz/SZZ/dokumenty/index.html#_dokumenty (prohlášení do ZP)
\begin{prohlaseni}
