...
\subsubsection{Pomocné funkce a třídy}
...
\begin{itemize}
    ...
    Metoda obdrží v argumentu funkce MAC adresu účastníka. Pokud je účastník s touto MAC adresu připojen, metoda vrací ve výstupním argumentu jeho aktuální IP adresu a vrácí úspěch. V opačném případě vrací neúspěch a jako IP adresu hodnotu \inlinecode{null}.
\end{itemize}
